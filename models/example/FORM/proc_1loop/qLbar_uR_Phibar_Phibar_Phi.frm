...
S SIX, SEVEN, FIVE, g1, gw, gs, lam, muH, MHT;
CF lamprime, yd, yl, yu, lamprimebar, ydbar, ylbar, yubar, Ta, FSU2L, T, FSU3C, fsu2, fsu3;
CF Evect;
...
#do i=1,25;
G expr'i'= diags'i';
#include qLbar_uR_Phibar_Phibar_Phi.aux;
...
repeat;
id,once prop(k1, 0)*prop(k1, MHT)= 1/(0^2-MHT^2)*(prop(k1, 0)- prop(k1, MHT));
endrepeat;
...
#else
G amplqLbaruRPhibarPhibarPhi=0;
