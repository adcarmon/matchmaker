...
S SIX, SEVEN, FIVE, g1, gw, gs, lam, muH, lamprimeQTL, lamprimeQTR, MHT, MHQ, lamprimeQTLbar, lamprimeQTRbar;
CF lamprime, lamprimeQd, lamprimeQu, yd, yl, yu, lamprimebar, lamprimeQdbar, lamprimeQubar, ydbar, ylbar, yubar, Ta, FSU2L, T, FSU3C, fsu2, fsu3;
CF Evect;
...
repeat;
id,once prop(k1, 0)*prop(k1, MHQ)= 1/(0^2-MHQ^2)*(prop(k1, 0)- prop(k1, MHQ));
endrepeat;
...
repeat;
id,once prop(k1, MHQ)*prop(k1, MHT)= 1/(MHQ^2-MHT^2)*(prop(k1, MHQ)- prop(k1, MHT));
endrepeat;
